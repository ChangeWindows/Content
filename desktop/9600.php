...
<?php echo $alerts; ?>
<a href="img/build/9600.png"><img src="img/build/9600.png" class="img-responsive build-img" alt="Screenshot current build" /></a>
<h3>Tiles</h3>
<ul>
...
<ul>
	...
	<li>Calendar
		<ul>
			<li>The interface has been revamped</li>
		</ul>
	</li>
	<li>Camera
		<ul>
	...
	<li>Mail
		<ul>
			<li>The mail interface has been revamped</li>
			<li>Support for drag and drop</li>
			<li>The Mail-app now uses the Outlook color</li>
		</ul>
	</li>
	<li>News
		<ul>
