<div class="panel panel-warning">
	...
	<div class="panel-body">
		<h2>What's new in the Windows Technical Preview?</h2>
		...
		<ul>
		  ...
		  <li>Aero Snap has been updated</li>
		  <ul>
		...
		<ul>
		  ...
		  <li>Search
			<ul>
			  <li>De Search-apps is now a default pinned item on the taskbar and can't be removed</li>
